  ...
  const figureOutData = [
    {
      ...
      articles:'6',
      concent:'Here for the first time? See how Substance can help from sales and marketing, to customer engagement and support.'
    },
    {
    ...
    <div>
     ...
     <div className="TeamBigBox">
      ...
      <Box sx={{ display: 'flex', alignItems: 'flex-end' }}>
        ...
        <TextField id="input-with-sx" label="Search for articles…" variant="standard" fullWidth/>
      </Box>
